...
export default function Card(props) {
    // console.log('Card')
    return (
        <div className="card col-3 px-4 py-3 m-5">
            <img src={props.info.thumbnail} style={{ maxHeight: 200, minHeight: 200 }} className="img-responsive   card-img-top img-thumbnail" alt="..." />
